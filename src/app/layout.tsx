  ...
  return (
    <html lang="en" className={roboto.variable}>
      <head>
        ...
        <meta name="title" content="Arma Plan Maker Online: Create your plan for Arma 3!" />
        <meta name="description" content="Create your plan for Arma 3!" />

        {/* <!-- Open Graph / Facebook --> */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://arma-plan-maker.com" />
        <meta property="og:title" content="Arma Plan Maker Online: Create your plan for Arma 3!" />
        <meta property="og:description" content="Create your plan for Arma 3!" />
        ...
        />
        <meta property="twitter:description" content="Create your plan for Arma 3!" />
