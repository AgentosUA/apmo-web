          ...
          <div className='flex flex-col w-full'>
            ...
            {combinedOptions.map((option) => (
              <div
                ...
                className='cursor-pointer hover:bg-a3-grey/15 px-2 py-1.5 text-sm'>
                {multiple ? (
